...
void	info_scene_3(t_scene *scene, t_mlx *mlx, int x, int y)
{
	...
	mlx_string_put(mlx->mlx, mlx->win, x, y + 200, TEXT_COLOR,
	"Materials:");
	mlx_string_put(mlx->mlx, mlx->win, x + 150, y + 200, TEXT_COLOR,
...
void	info_scene_4(t_scene *scene, t_mlx *mlx, int x, int y)
{
	...
	"- planes:");
	mlx_string_put(mlx->mlx, mlx->win, x + 350, y + 100, TEXT_COLOR,
	str = ft_itoa(scene->objs.quant_planes));
	free(str);
	mlx_string_put(mlx->mlx, mlx->win, x + 190, y + 120, TEXT_COLOR,
	"- spheres:");
	mlx_string_put(mlx->mlx, mlx->win, x + 350, y + 120, TEXT_COLOR,
	str = ft_itoa(scene->objs.quant_spheres));
	free(str);
	mlx_string_put(mlx->mlx, mlx->win, x + 190, y + 140, TEXT_COLOR,
	"- cylinders:");
	mlx_string_put(mlx->mlx, mlx->win, x + 350, y + 140, TEXT_COLOR,
	str = ft_itoa(scene->objs.quant_cylinders));
	free(str);
	mlx_string_put(mlx->mlx, mlx->win, x + 190, y + 160, TEXT_COLOR,
	"- cones:");
	mlx_string_put(mlx->mlx, mlx->win, x + 350, y + 160, TEXT_COLOR,
